...
class instructorEditContact(object, EditContactInfoInterface):
    def editInfo(editContact):
        ...
        #Postcondition: Side-effects: the user has the ability to change contact information, and information will change in administrator all data to view as well
    ...
    def edit(contactInfo):
        ...
        #Side-effects: When any other user goes to see public information of the particular user changing their contact they can view the updated information
